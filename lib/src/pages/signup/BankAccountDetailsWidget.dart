...
class _BankAccountDetailsWidgetState extends StateMVC<BankAccountDetailsWidget> {
  ...
  _BankAccountDetailsWidgetState() : super(UserController()) {
                              ...
                              onTap: () async {
                                ...
                                if (pickedFile != null) {
                                  setState(() {
                                    ...
                                    _con.user.bankAccountDetails = pickedFile.path;
                                  });
                                }
                              },
                              child: Container(
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          ElevatedButton(
                            ...
                            onPressed: (selectedFile != null && _formKey.currentState!.validate()) ? () {
                              _formKey.currentState!.save();
                              // Here you can add the logic to submit all documents
