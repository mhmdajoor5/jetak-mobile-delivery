...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "address_not_provided_contact_client": MessageLookupByLibrary.simpleMessage(
      "Adresse non fournie contacter le client",
    ),
    "address_not_provided_please_call_the_client":
        MessageLookupByLibrary.simpleMessage(
          "Adresse non fournie veuillez appeler le client",
        ),
    ...
    "recent_orders": MessageLookupByLibrary.simpleMessage(
      "Dernières commandes",
    ),
    ...
    "reset_your_cart_and_order_meals_form_this_restaurant":
        MessageLookupByLibrary.simpleMessage(
          "Réinitialisez votre panier et commandez des repas dans ce restaurant",
        ),
    "restaurant_refreshed_successfuly": MessageLookupByLibrary.simpleMessage(
      "Le restaurant a été rafraîchi avec succès",
    ),
    ...
    "start_exploring": MessageLookupByLibrary.simpleMessage(
    ...
    "swip_left_the_notification_to_delete_or_read__unread":
        MessageLookupByLibrary.simpleMessage(
          "Faites glisser la notification vers la gauche pour la supprimer ou la lire",
        ),
    ...
    "the_food_was_removed_from_your_cart": MessageLookupByLibrary.simpleMessage(
      "Le \$foodName a été supprimé de votre panier",
    ),
    ...
    "would_you_please_confirm_if_you_have_delivered_all_meals":
        MessageLookupByLibrary.simpleMessage(
          "Veuillez confirmer si vous avez livré tous les repas au client",
        ),
    ...
    "you_dont_have_any_order_assigned_to_you":
        MessageLookupByLibrary.simpleMessage(
          "Vous n\'avez aucune commande qui vous est assignée!",
        ),
    ...
    "your_have_an_order_assigned_to_you": MessageLookupByLibrary.simpleMessage(
      "Vous avez une commande qui vous est attribuée",
    ),
